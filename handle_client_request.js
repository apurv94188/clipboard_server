//const cfg = require('./config/config_env.js');
...
const route_add = require('./module_add/add-clip.js');
const route_home = require('./module_home/home.js')
...
//cf.log_msg('reading from env' + cfg.NODE_ENV);

app.use('/home', route_home, (req, res) => {
    return;
});
app.use('/searchClip', jsonParser, route_search);
app.use('/addClip', jsonParser, route_add);
